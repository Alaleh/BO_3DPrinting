...
def generate_feasible_points(n_ranges, already_evaluated):
    data_points = []
    value_ranges = [[4, 155, 115], [4.1, 156.5, 116.5], [4.2, 158, 118], [4.3, 159.5, 119.5], [4.4, 161, 121],
                    ...
                    [7.2, 197, 152], [7.3, 198, 153], [7.4, 199, 154], [7.5, 200, 155], [7.6, 201, 156],
                    [7.7, 202, 157],
                    [7.8, 203, 158], [7.9, 204, 159], [8, 205, 160], [8.1, 207, 161.5], [8.2, 209, 163],
                    [8.3, 211, 164.5],
                    [8.4, 213, 166], [8.5, 215, 167.5], [8.6, 217, 169], [8.7, 219, 170.5], [8.8, 221, 172],
                    [8.9, 223, 173.5],
                    ...
                    [10.7, 238.5, 198.5], [10.8, 239, 199], [10.9, 239.5, 199.5], [11, 240, 200], [11.1, 240, 200.5],
                    [11.2, 240, 201],
                    ...
                    [13.7, 243.5, 208.5], [13.8, 244, 209], [13.9, 244.5, 209.5], [14, 245, 210], [14.1, 245.5, 211],
                    [14.2, 246, 212],
...
def main():
    ...
    feasible_points = generate_feasible_points(input_ranges, used_points)
